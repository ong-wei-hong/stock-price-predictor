...
<!--To install and run: docs/installation.md.-->

To see version history: docs/version-history.md

<!--To see project strucutre: docs/docs.md -->

<!--Visit the other repos of this project:
- [backend](https://www.example.com)
- [ML model](https://www.example.com)
-->
